...
typedef struct PL011_t
{
    ...
    uint32_t    reserved2[6];   //0x05C-0x07C
    UARTITCR_t  uartitcr;       //0x080
    UARTITIP_t  uartitip;       //0x084
    UARTITOP_t  uartitop;       //0x088
    UARTTDR_t   uarttdr;        //0x08C
} PL011_t;

#define UART_BASE_ADDRESS       0x3F201000
#define UART_INTERRUPT          57
